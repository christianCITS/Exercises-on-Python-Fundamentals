...
for x in worldcup:
    if x["Team"]==("Italy") or x["Team"]==("ITA"):
          calciatoriita.append(x["FullName"]) 
    elif x["Team"]==("Brazil") or x["Team"]==("BRA"):
          calciatoribra.append(x["FullName"])
    elif x["Team"]==("Argentina") or x["Team"]==("ARG"):
          calciatoriarg.append(x["FullName"])
          
          
calciatoriita=set(calciatoriita)
calciatoribra=set(calciatoribra)   
calciatoriarg=set(calciatoriarg)     
